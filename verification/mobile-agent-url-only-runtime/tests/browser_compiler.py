        ...
        for count in (2,3,4):
            ...
            for stage_id in stage_ids:
                ...
                page.wait_for_function(
                    "stage => document.documentElement.dataset.stage === stage", arg=stage_id, timeout=30000
                )
            ...
            assert all(checks.values()), {"checks":checks,"errors":errors,"failed":failed,"metrics":metrics}
            cases.append({
