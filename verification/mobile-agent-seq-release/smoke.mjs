...
try {
  ...
  const receipt = { schema: "ops.mobileAgentSeqPublicProof/1", status: "PASS", authority: false, url: page.url(), preset: "seq/1", maxGraph: true, interaction, sourceExportBytes: exported.bytes, browserErrors: 0, failedProductResponses: 0 };
