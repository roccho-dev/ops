...
import { runGovernanceFixtureE2E } from "./governance-fixture-e2e.mjs";
...
assert.equal(golden.active, 3);
assert.equal(golden.out_of_scope, golden.packages - golden.active);
assert.equal(golden.organization_active_minted, false);
