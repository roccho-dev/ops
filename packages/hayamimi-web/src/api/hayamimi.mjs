...
export class Hayamimi extends EventTarget {
  constructor({secondOpinion=false}={}){super();this.root=new URL('../../',import.meta.url);this._running=false;this.onText=null;this.asr=new AsrClient(this.root,{secondOpinion,onText:text=>{this.onText?.(text);this.dispatchEvent(new CustomEvent('text',{detail:text}))}});this.mic=new Microphone(this.root,s=>this.asr.push(s))}
