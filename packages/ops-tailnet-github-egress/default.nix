builtins.fromJSON ''
{
  ...
  "repoId": "ops",
  "mission": "Run GitHub operations through a tag:github tailnet egress path while keeping local gh and local GitHub API usage forbidden.",
  "primaryTarget": "packages/ops-tailnet-github-egress",
  "requiredOutputs": "packages.<system>.ops-tailnet-github-egress",
  "requiredChecks": "ops-tailnet-github-egress.offline-contract plus static all-IPv4 snippet guards",
  "responsibility": "Expose policy, live reachability checks, remote GitHub SSH checks, all-IPv4 route-gated local GitHub push, long-transfer App Connector push, single-remote ref restore, remote exec, and existing-repo push delegation through the egress path.",
